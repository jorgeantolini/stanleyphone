...
//        this._gMapDiv.css({'min-width': this.width() + 'px', 'min-height' :this.height() + 'px'});
    ...
    _loadApi: function(apiKey) {
        if (typeof GMap2 != "function") {
            ...
            var link = "http://maps.google.com/maps?file=api&v=2&sensor=true&async=2&key=" + apiKey + "&callback=gMapWidgetApiLoaded";
...
AC.Core.Widgets().registerExWidget("WiziCore_UI_GoogleMapsWidget", "sections_extensible", "widget_name_gmap", "gmaps",
