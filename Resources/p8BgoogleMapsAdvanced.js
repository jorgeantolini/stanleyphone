...
//        if (currentLanguage != language || (currentLanguage == null && language == null) ||
//            typeof google == "undefined" || typeof google.maps == "undefined" || typeof google.maps.Map != "function") {
...
//        if (((currentLanguage == null && lang == null) || currentLanguage != lang) && !isLoading) {
        if (!isLoading) {
...
//    function loadGears() {
//        loadGearsLib && loadGearsLib();
//    }
//
//    function loadGearsLib() {
//        if (typeof google == "undefined" || typeof google.gears == "undefined")
//            jQuery.getScript("http://code.google.com/apis/gears/gears_init.js");
//
//        loadGearsLib = null;
//    }
...
//        (WiziCore_Helper.isMobile() === true) ? options.draggable = false : null;
    ...
    p.whereAmI = function(callback) {
        if (!hasLatLngObj())
            ...
            if(navigator.geolocation) {
             ...
             self._onCurrentLocationUpdated(true, {latitude: position.latitude, longitude: position.longitude}, callback);
             }, function(error) {
             self._onCurrentLocationUpdated(false, {msg:AC.Core.lang().trText("widget_gmap_gloc_failed"), errorCode: error.code, errorMsg: error.message}, callback);
             });
             } else*/ {
...
//                    overlayToAdd.onClickHTML = overlayData.onClickHTML;
    ...
    // template properties
    p.isIncludedInSchema = AC.Property.normal('isIncludedInSchema');
...
if (window['jqSimpleGrid'] && window['jqSimpleGrid'].types && window['jqSimpleGrid'].types['basenumber']) {
     ...
     * zoom level
     */
    gType.gmzoomlevel = function(cell) {
        this.cell(cell);
        this._prefix = "";
        this._maxValue = 20;
        this._minValue = 1;
    ...
    gType.gmzoomlevel.prototype = new gType.slidertype;

    /**
     * google maps api key list data
     */
    gType.gmapkeysdata = function(cell) {
        this.cell(cell);
        this._cellTitle = "widget_gmap_apikeys";
        this._appendText = "<a href='https://code.google.com/apis/console' target='_blank' style='color:#001aff;'>Sign Up to get Google Api Key</a>";
        this._props = {"height": 300};
        this._model = [
            {
                "title":  AC.Core.lang().trText("widget_gmap_hostname"),
                "width": 30,
                "align":"center",
                "type":"text"
            },
            ...
            {
                "title":  AC.Core.lang().trText("widget_gmap_apikey"),
                "width": 70,
                "align":"center",
                "type":"text"
            }
    ...
    gType.gmapkeysdata.prototype = new gType.flist;
    })(jqSimpleGrid.types);
}
